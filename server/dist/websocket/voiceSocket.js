...
export function handleVoiceSocket(ws) {
    ...
    // ─── Event Handlers ───────────────────────────────────────────────────────
    async function handleStartCall(ws, language) {
        ...
        try {
            ...
            const fallbackGreeting = lang === "hi-IN"
    ...
    async function handleAudioData(ws, sid, audioBase64) {
        ...
        try {
            ...
            if (audioBuffer.length < 1000) {
                ...
                try {
                    const retryAudio = await textToSpeech("I couldn't hear that clearly. Could you please speak again?", session.language);
                    sendEvent(ws, {
                        type: "ai_audio",
                        data: retryAudio,
                        format: "wav",
            ...
            if (!sttResult) {
                ...
                const retryMessage = "Sorry, I couldn't understand that. Could you please repeat what you said?";
            ...
            const errorMessage = "I'm having trouble processing your response. Could you try speaking again?";
    ...
    async function handleEndCall(ws, sid) {
